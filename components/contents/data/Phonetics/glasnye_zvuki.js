...
export const glasnye_zvuki = (
  <View>
    <P>
      Как отмечалось (см. п. 1.5. Звуки речи и буквы), в русском языке{" "}
      <Strong>6 основных</Strong> (то есть тех, что произносятся под ударением){" "}
      <Strong>гласных звуков</Strong>:
    </P>
    <Table>
      <Row>
        <Col>
    ...
    <P>
      которые обозначаются на письме <Strong>10 буквами</Strong>:
    </P>
    <Table>
      <Row>
        <Col>
    ...
    <P>
      <Strong>
        <Span className="number">1.</Span> Употребление гласных в составе слова
    ...
    <P>
      ...
      В безударном положении (в слабой позиции) все гласные звуки произносятся с
    ...
    <P>
      ...
      <Li>
          ...
          обычно звук, близкий к <Span className="litera0">[а]</Span>. В
          школьном варианте транскрипции его принято обозначать как
          ...
          специальный знак <Span className="litera0">[&Lambda;]</Span>.
            ...
            [мо&#769;j] &ndash;{" "}
            <Em>
              м<Span className="litera">о</Span>я
            </Em>
            [м&Lambda;jа&#769;] или [маjа&#769;],{" "}
            <Em>
              д<Span className="litera">а</Span>л
            </Em>{" "}
            [да&#769;л] &ndash;
            <Em>
      ...
      <Li>
          ...
          транскрипции его принято обозначать как{" "}
          <Span className="litera0">[и]</Span>, хотя этот звук звучит скорее как{" "}
          <Span className="litera0">[и]</Span> с призвуком{" "}
          ...
          .
            ...
            [вз&rsquo;а&#769;л] &ndash;{" "}
            <Em>
              вз<Span className="litera">я</Span>ла
            </Em>{" "}
            [вз&rsquo;и<Sup>э</Sup>ла&#769;] или [вз&rsquo;ила&#769;],
            <Em>
              н<Span className="litera">ё</Span>с
            </Em>{" "}
            [н&rsquo;о&#769;с] &ndash;{" "}
            <Em>
              н<Span className="litera">е</Span>сла
            </Em>{" "}
            [н&rsquo;и<Sup>э</Sup>сла&#769;] или [н&rsquo;исла&#769;],
            <Em>
              б<Span className="litera">е</Span>л
            </Em>{" "}
            [б&rsquo;е&#769;л] &ndash;{" "}
            <Em>
    ...
    <Table>
      <Row>
        <Col>
          <Strong>
            Итак, в I слабой позиции на месте{" "}
            <Span className="litera0">[а], [о], [э]</Span> после твёрдых
            согласных звучит звук, близкий к{" "}
            <Span className="litera0">[а]</Span> &ndash;{" "}
            <Span className="litera0">[&Lambda;]</Span>, после мягких согласных
            &ndash; звук, близкий к <Span className="litera0">[и]</Span> &ndash;{" "}
            <Span className="litera0">
              [и<Sup>э</Sup>]
            </Span>
            .
    ...
    <P>
      <Strong>
        <Span className="number">5.</Span> Исключение
      </Strong>{" "}
      могут составлять некоторые слова с гласными{" "}
      <Span className="litera0">[а], [о], [э]</Span> в I слабой позиции после
      ...
      <Li>
          ...
          <Span className="litera0">
            ...
            л&rsquo;э&#769;т&rsquo;],{" "}
            <Em>
              лош<Span className="litera">а</Span>дей
            </Em>{" "}
            [лъш
            <Span className="litera0">
              ы<Sup>э</Sup>
            ...
            д&rsquo;э&#769;j],
            <Em>
              двадц<Span className="litera">а</Span>ти
            </Em>{" "}
            [двъц
            <Span className="litera0">
              ы<Sup>э</Sup>
      ...
      <Li>
          ...
          <Span className="litera0">[э]</Span>, &ndash;{" "}
          <Span className="litera0">
            [ы<Sup>э</Sup>]
          </Span>
          ;
    ...
    <P>
      ...
      В других безударных слогах (второй, третий предударные слоги, заударные
      ...
      <Li>
          ...
          после твёрдых согласных, &laquo;ерь&raquo;{" "}
          <Span className="litera0">[ь]</Span> &ndash; после мягких согласных.
          (На данном ресурсе используется упрощённый вариант транскрипции
          гласных, то есть не учитываются особенности произношения гласных [о],
          [а], [э] в закрытых и открытых заударных слогах, разница произношения
          [о], [а], [э] в заударном слоге и др.)
        {"\n"}
        Например:
        {"\n"}
          после твёрдых согласных:{" "}
          <Em>
            д<Span className="litera">о</Span>мовой
          </Em>{" "}
          [д<Span className="litera0">ъ</Span>маво&#769;j],{" "}
          <Em>
            рыб<Span className="litera">а</Span>
          </Em>{" "}
          [ры&#769;б<Span className="litera0">ъ</Span>],{" "}
          <Em>
            крыш<Span className="litera">а</Span>
          </Em>{" "}
          [кры&#769;ш<Span className="litera0">ъ</Span>],{" "}
          <Em>
            ц<Span className="litera">е</Span>ликом
          </Em>{" "}
          [ц<Span className="litera">ъ</Span>л&rsquo;ико&#769;м];
        {"\n"}
          после мягких согласных:{" "}
          <Em>
            р<Span className="litera">я</Span>довой
          </Em>{" "}
          [р&rsquo;<Span className="litera0">ь</Span>даво&#769;j],{" "}
          <Em>
            пол<Span className="litera">е</Span>
          </Em>{" "}
          [по&#769;л&rsquo;<Span className="litera0">ь</Span>],{" "}
          <Em>
            ч<Span className="litera">а</Span>совщик
          </Em>{" "}
    ...
    <P>
      ...
      <Strong>Исключение</Strong> составляет II слабая позиция гласных в
      абсолютном начале слова <Span className="litera0">[а], [о]</Span>. На
      месте данных гласных в начале слова звучит не редуцированный
      &laquo;ер&raquo; <Span className="litera0">[ъ]</Span>, а звук, близкий к{" "}
      <Span className="litera0">[а]</Span>
    ...
    <Table>
      ...
      <Row>
        ...
        <Col>
          ...
          {"\n"}
            <Em>
              Со-жа-л<Span className="uDouble">е&#769;</Span>-ни-е.
            </Em>
          {"\n"}
            Ударный гласный не меняет своего звучания. Учтите только, что буквы{" "}
            <Span className="litera">е, ё, ю, я</Span> могут обозначать:
            {"\n"}
              либо один звук <Span className="litera0">[э], [о], [а], [у]</Span>{" "}
              &ndash; после мягких согласных (как в слове{" "}
              <Em>со-жа-ле&#769;-ни-е</Em>);
            {"\n"}
                либо два звука: согласный <Span className="litera0">[ j ]</Span>{" "}
                + гласный <Span className="litera0">[э], [о], [а], [у]</Span>{" "}
                &ndash; в начале слова, после гласного и после разделительных{" "}
                <Span className="litera">ъ</Span> и{" "}
                <Span className="litera">ь</Span>.
              <Em>
                Явный &ndash; <Span className="uDouble">я&#769;</Span>-вный,
      ...
      <Row>
        ...
        <Col>
          ...
          {"\n"}
            первый предударный слог &ndash; I слабая позиция; остальные
            безударные слоги &ndash; II слабая позиция.
          {"\n"}
            <Em>Со</Em>
            <Sup>II</Sup>-<Em>жа</Em>
            <Sup>I</Sup>-<Em>л</Em>
            <Span className="uDouble">е&#769;</Span>-<Em>ни</Em>
            <Sup>II</Sup>-<Em>е</Em>
            <Sup>II</Sup>.
          {"\n"}
            Если среди этих гласных есть звуки{" "}
            <Span className="litera0">[и], [ы], [у]</Span> (буквы{" "}
            <Span className="litera">и, ы, у, ю</Span>), то подчеркните их одной
            чертой: они не изменяют своего звучания в безударном положении.
          <Em>Со</Em>
          <Sup>II</Sup>-<Em>жа</Em>
          <Sup>I</Sup>-<Em>л</Em>
          <Span className="uDouble">е&#769;</Span>-
          <Em>
            н<Span>и</Span>
          </Em>
          <Sup>II</Sup>-<Em>е</Em>
      ...
      <Row>
        ...
        <Col>
          <Strong>
            ...
            <Span className="litera">е, э, о, а</Span>:
          </Strong>
            {"\n"}
                после твёрдых согласных &ndash;{" "}
                <Span className="litera0">[&Lambda;]</Span>;
            {"\n"}
                после мягких согласных &ndash;{" "}
                <Span className="litera0">
                  [и<Sup>э</Sup>]
                </Span>
                ;
            {"\n"}
                после <Span className="litera">ж, ш, ц</Span> может звучать{" "}
                <Span className="litera0">
                  [ы<Sup>э</Sup>]
                </Span>
                .
            ...
            <Sup>II</Sup>-<Em>е</Em>
            <Sup>II</Sup>
            &ndash; в слоге <Em>жа</Em> звучит гласный [ы<Sup>э</Sup>].
          {"\n"}
            Учтите, что если буквы <Span className="litera">е, я</Span>{" "}
            обозначают два звука: согласный{" "}
            <Span className="litera0">[ j ]</Span> + гласный{" "}
            <Span className="litera0">[э], [а]</Span>, то эти гласные также
            изменяются по общим правилам: <Span className="litera">j</Span>{" "}
            &ndash; мягкий согласный, значит, после него на месте букв{" "}
            <Span className="litera">е, я</Span> будет звучать звук{" "}
            <Span className="litera0">
              [и<Sup>э</Sup>]
            </Span>
            .
          {"\n"}
            <Em>Объявился &ndash; о</Em>
            <Sup>II</Sup>-<Em>бъя</Em>
            <Sup>I</Sup>-<Em>ви&#769;л-ся</Em>
            <Sup>II</Sup>
      ...
      <Row>
        ...
        <Col>
          <Strong>
            ...
            {"\n"}
                после твёрдых согласных &ndash;{" "}
                <Span className="litera0">[ъ]</Span>;
             {"\n"}
                после мягких согласных &ndash;{" "}
                <Span className="litera0">[ъ]</Span>;
            {"\n"}
                в абсолютном начале слова на месте букв{" "}
                <Span className="litera">о</Span> и{" "}
                <Span className="litera">а</Span> &ndash;{" "}
                <Span className="litera0">[&Lambda;]</Span>.
             {"\n"}
            Учтите, что если буквы <Span className="litera">е, я</Span>{" "}
            обозначают два звука: согласный{" "}
          ...
          <Sup>II</Sup>-<Em>е</Em>
          <Sup>II</Sup> &ndash; слог <Em>со</Em> с твёрдым согласным звучит как
          [съ]; слог <Em>е</Em> ([j] + гласный) звучит как [ь]; о<Sup>II</Sup>-
          <Em>бъя</Em>
          <Sup>I</Sup>-<Em>ви&#769;л-ся</Em>
